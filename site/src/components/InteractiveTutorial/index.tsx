...
import type { TutorialInteractiveMeta, TutorialMessage } from '@tutorials/_shared/interactive-types';
import { dispatchMessage, resetRuntime, traceFromRuntime, type InteractiveRuntime } from '@tutorials/_shared/interactive-helpers';
...
export default function InteractiveTutorial({ meta }: InteractiveTutorialProps): React.ReactElement {
	...
	return (
		<section className={styles.panel} aria-label={`Interactive tutorial: ${meta.title}`}>
