...
Use **`then()`** for choice/junction pseudo states. Use **`post()`** when the follow-up should be a separate, externally visible event ([Post & sync](../08-post-and-sync/README.md)).

See also [Complex workflow](../15-complex-workflow/README.md) for `then()` after async validation.
