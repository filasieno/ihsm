...
Hands-on walkthroughs: [tutorials](/tutorials/) · [source index](/tutorials)
...
Tutorial: [../tutorials/03-context/README.md](/tutorials/03-context)
...
Tutorial: [../tutorials/04-protocol-typing/README.md](/tutorials/04-protocol-typing)
...
Tutorial: [../tutorials/05-hierarchy/README.md](/tutorials/05-hierarchy)
...
Tutorial: [../tutorials/05-hierarchy/README.md](/tutorials/05-hierarchy) (entry/exit and deep-stack topology)
...
Tutorial: [../tutorials/07-internal-transitions/README.md](/tutorials/07-internal-transitions)
...
Tutorial: [../tutorials/11-restore/README.md](/tutorials/11-restore)
...
Tutorial: [../tutorials/14-nested-machines/README.md](/tutorials/14-nested-machines)
...
[tutorial 05](/tutorials/05-hierarchy) and
...
Tutorial: [../tutorials/08-post-and-sync/README.md](/tutorials/08-post-and-sync)
...
Tutorial: [../tutorials/10-call-services/README.md](/tutorials/10-call-services)
...
Tutorial: [../tutorials/09-deferred-post/README.md](/tutorials/09-deferred-post)
...
for those jobs (see [tutorial 08](/tutorials/08-post-and-sync)).
...
Tutorial: [../tutorials/05-hierarchy/README.md](/tutorials/05-hierarchy)
(shallow entry/exit chain and [case-by-case topology](https://github.com/filasieno/ihsm/tree/master/tutorials/05-hierarchy/cases/)).
...
[tutorial 07](/tutorials/07-internal-transitions)).
...
See [§4 `sync()`](#sync) and [tutorial 08](/tutorials/08-post-and-sync).
...
Tutorial: [../tutorials/02-tracing/README.md](/tutorials/02-tracing) (**start here** after tutorial 01). Every other tutorial includes a **Reading the trace** section.
...
Tutorial: [../tutorials/12-error-recovery/README.md](/tutorials/12-error-recovery)
...
Tutorial: [../tutorials/13-async-handlers/README.md](/tutorials/13-async-handlers)
...
Tutorial: [../tutorials/01-hello-state-machine/README.md](/tutorials/01-hello-state-machine)
