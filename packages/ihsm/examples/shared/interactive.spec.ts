...
const all = [t00, t01, t02, t03, t04, t05, t07, t08, t09, t10, t11, t12, t13, t14, t15, t17, t18, testing01, testing02, testing03, testing04, testing05];
...
describe('Interactive tutorial metadata', () => {
	for (const [index, meta] of all.entries()) {
		it(`tutorial ${index + 1} exposes senders and messages`, () => {
			...
			expect(summary).to.match(/State:|Payment:|Gateway state:/);
		});
	}
