...
test -f "$DIST/api/index/functions/makeHsm/index.html"
grep -q 'State as class' "$DIST/reference/index.html"
grep -q 'Tutorial playground' "$DIST/reference/index.html"
grep -q 'makeHsm' "$DIST/api/index/functions/makeHsm/index.html"
grep -q 'API Reference' "$DIST/api/index.html"
grep -q 'UML state diagram' "$DIST/reference/index.html"
grep -q 'Tracing' "$DIST/reference/index.html"
grep -q 'Deterministic testing' "$DIST/testing/index.html"
