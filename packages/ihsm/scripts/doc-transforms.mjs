...
export function transformSiteLinks(text) {
	...
	const exampleAnchors = {
		'01-hello-state-machine': '#example-01-hello-state-machine',
		'02-tracing': '#example-02-tracing',
		'03-context': '#example-03-context',
		'04-protocol-typing': '#example-04-protocol-typing',
		'05-hierarchy': '#example-05-hierarchy',
		'07-internal-transitions': '#example-07-internal-transitions',
		'08-post-and-sync': '#example-08-post-and-sync',
		'09-deferred-post': '#example-09-deferred-post',
		'10-call-services': '#example-10-call-services',
		'11-restore': '#example-11-restore',
		'12-error-recovery': '#example-12-error-recovery',
		'13-async-handlers': '#example-13-async-handlers',
		'14-nested-machines': '#example-14-nested-machines',
		'15-complex-workflow': '#example-15-complex-workflow',
		'17-post-now': '#example-17-post-now',
		'18-chained-child-actors': '#example-18-chained-child-actors',
		'19-request-manager': '#example-19-request-manager',
	};
