...
export const topics = [
	...
	},
	{
		...
		title: 'Post & sync',
		sidebarPosition: 7,
		reference: [{ section: '4', subsections: ['`notify` + `sync()`', '`sync()`'] }],
	...
	},
	{
		...
		title: 'postNow',
		sidebarPosition: 15,
		reference: [{ section: '4', subsections: ['`notifyNow`', '`sync()`'] }],
		tutorial: '17-post-now',
	},
	{
		id: '18-chained-child-actors',
		title: 'Chained child actors',
		sidebarPosition: 16,
		reference: [{ section: '2', subsections: ['Chained child actors'] }],
		tutorial: '18-chained-child-actors',
	},
	{
		id: '19-request-manager',
		title: 'Request manager',
		sidebarPosition: 17,
		reference: [{ section: '2', subsections: ['Request manager (cancellable command children)'] }],
		tutorial: '19-request-manager',
	},
	{
		id: 'make-hsm',
		title: 'makeHsm',
